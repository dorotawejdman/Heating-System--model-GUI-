###########################################################################
## Makefile generated for Simulink model 'finale'. 
## 
## Makefile     : finale.mk
## Generated on : Thu Nov 21 20:44:49 2019
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/finale.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = E:/Air/PKSS/Matlab Model-20191022T123612Z-001/Matlab Model
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = finale_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = finale_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/finale.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/finale_ert_rtw -I$(START_DIR) -IE:/Air/PKSS -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=finale -DNUMST=2 -DNCSTATES=12 -DHAVESTDIO
...
SRCS = $(START_DIR)/finale_ert_rtw/finale.c

MAIN_SRC = $(START_DIR)/finale_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/finale_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
