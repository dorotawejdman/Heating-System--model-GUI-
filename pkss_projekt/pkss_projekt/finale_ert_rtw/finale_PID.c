...
void finale_step(void)
{
...

  {
    ...
    rtDW.FilterCoefficient_o = ((TrSp[T0counter] - rtX.wyjscieTr_CSTATE) * D -
      rtX.Filter_CSTATE_n) * 100.0;

    Fcob_i = (((TrSp[T0counter] - rtX.wyjscieTr_CSTATE) + rtX.Integrator_CSTATE_h) +
    ...
    //  5   //
    uMhCh_tmp = (rtX.wyjscieTpco_CSTATE - rtX.wyjscieTr_CSTATE) * 12000.0;
    rtDW.uMhCh = ((rtX.wyjscieTzco_CSTATE - rtX.wyjscieTpco_CSTATE) * (4.2E+6 *
      rtb_Fcob) - uMhCh_tmp) * 1.234567901234568E-7;



    rtDW.FilterCoefficient_b = ((TrSp[T0counter] - rtX.wyjscieTr_CSTATE_i) * D -
      rtX.Filter_CSTATE_g) * 100.0;

    // PID_Ub
    Fcob_i = (((TrSp[T0counter] - rtX.wyjscieTr_CSTATE_i) + rtX.Integrator_CSTATE_hz) +
    ...
    //  6   //
    Gain2_tmp = (rtX.wyjscieTpco_CSTATE_i - rtX.wyjscieTr_CSTATE_i) * 12000.0;
    rtDW.Gain7 = (Gain2_tmp - (rtX.wyjscieTr_CSTATE_i - T0[T0counter]) * 15000.0) * 5.0E-8;
    ...
    rtDW.IntegralGain_o = (TrSp[T0counter] - rtX.wyjscieTr_CSTATE_i) * I;
    rtDW.IntegralGain_j = (TrSp[T0counter] - rtX.wyjscieTr_CSTATE) * I;
    rtDW.Gain7_c = (uMhCh_tmp - (rtX.wyjscieTr_CSTATE - 1.0) * 15000.0) * 5.0E-8;
...
if (counter%30000==0)
{
    ...
    printf("Tr= %f \t", rtX.wyjscieTr_CSTATE);
    ...
    //fprintf(fp,"\n%f;%f;%f;%f;%f;%f;%f;%f;%f",T0[T0counter],rtX.wyjscieTr_CSTATE,rtX.wyjscieTpco_CSTATE,rtX.wyjscieTpm_CSTATE,rtX.wyjscieTzco_CSTATE,Tzm,Fcob_i,rtb_Fcob,TrSp[T0counter]);
